      ...
      <View style={{ flex: 1 }}>
...

        {
          ...
          <ScrollView >
            ...
            {this.props.cashier && this.props.cashier.map((value, id) => <CardCashier key={id} value={value} checked={this.props.cashierChecked.find(element => element.id == id)} dispatch={this.props.dispatch} />)}
